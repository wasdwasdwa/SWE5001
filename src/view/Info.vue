<template>
  <div>
    <div style="font-weight: bolder;font-size: 25px;padding-top: 40px;padding-bottom: 40px">Introduction</div>
    <div style="line-height: 30px;text-indent:2.5em;padding-top: 20px;padding-bottom: 20px"> {{film.introduction}}
    </div>
    <div style="font-weight: bolder;font-size: 25px;padding-top: 40px;padding-bottom: 40px">Actors</div>
